...
export default function ChainId() {
  ...
  return (
    <div className="flex flex-col items-start min-w-56">
      ...
      : <Badge className="bg-black border-2 border-white/50 hover:bg-white/10 text-[#FF0]/80 py-1 mt-1" style={{ whiteSpace: 'nowrap' }}>{data.chain_id}</Badge>
      }
      ...
      {isPending ? <Badge className="bg-black border-2 border-white/50 hover:bg-white/10 text-[#FF0]/80 py-1" style={{ whiteSpace: 'nowrap' }}>Checking...</Badge>
      : <Badge className="bg-black border-2 border-white/50 hover:bg-white/10 text-[#FF0]/80 py-1 mt-1" style={{ whiteSpace: 'nowrap' }}>{data.epoch}</Badge>
      }
    </div>
  )
}
