  ...
  return (
    <form className="flex items-center" onSubmit={handleSubmit}>   
        ...
        <div className="relative w-full">
            ...
            <input type="text" autoComplete="off" value={search} onChange={e => setSearch(e.target.value)} pattern="[a-zA-Z0-9]+" id="simple-search" className="bg-white/10 border border-2 border-light text-light text-sm rounded-full outline-none focus:outline-none focus:bg-black focus:border-cyan hover:border-cyan hover:bg-black block w-full ps-10 p-3" placeholder="Search for validator / tx hash / block height / address" required />
        </div>
